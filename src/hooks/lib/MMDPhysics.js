	...
	_init() {
		...
		function createGeometry(param) {
			...
			switch (param.shapeType) {
				...
				case 0:
					return new SphereGeometry(param.width / 2, 16, 8);

				case 1:
					return new BoxGeometry(param.width, param.height, param.depth, 8, 8, 8);

				case 2:
					return new CapsuleGeometry(param.width / 2, param.height, 8, 16);
